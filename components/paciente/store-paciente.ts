...
class StoreUsuario {
  ...
  async insertar_paciente(paciente: Paciente_INT) {
    return await new Promise((resolve, reject) => {
      database.query(
        `INSERT INTO paciente (id_paciente, nombres, apellidos, nacimiento, peso, altura, codigo, img) VALUES ('${paciente.id_paciente}', '${paciente.nombres}', '${paciente.apellidos}', '${paciente.nacimiento}', ${paciente.peso}, ${paciente.altura}, '${paciente.codigo}', '${paciente.img}')`,
        (err, data) => {
