...
class StoreSeguimiento {
  ...
  async registrar_seguimiento(seguimineto: Peso_Altura_INT) {
    return await new Promise((resolve, reject) => {
      database.query(
        `INSERT INTO seguimiento (id_seguimiento, peso, altura, id_paciente, fecha_seguimiento, temperatura) VALUES ('${seguimineto.id_seguimiento}', ${seguimineto.peso}, ${seguimineto.altura}, '${seguimineto.id_paciente}', '${seguimineto.fecha_seguimineto}', ${seguimineto.temperatura})`,
        (err, data) => {
